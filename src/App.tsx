...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50 overflow-hidden font-sans relative">
      ...
      {/* Top Navigation Bar */}
      <header className="flex-none h-20 bg-white border-b border-sky-100 flex items-center justify-between px-4 sm:px-6 z-40 shadow-sm relative">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <img src="/Picture1.png" alt="Jesus" className="h-14 w-auto object-contain drop-shadow-sm" />
            <span className="hidden sm:block font-extrabold text-2xl text-sky-950 tracking-tight">
        ...
        <div className="flex-1 max-w-xl mx-4 relative group z-50">
          ...
          <input
            ...
            className="block w-full pl-12 pr-4 py-3 border-2 border-sky-100 rounded-full leading-5 bg-sky-50 placeholder-sky-400 focus:outline-none focus:ring-4 focus:ring-sky-200 focus:border-sky-400 sm:text-lg font-medium text-sky-900 transition-all shadow-inner"
          />
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => setActiveTab('stats')} className="relative group">
            <img src="/Picture4.png" className="h-14 w-auto object-contain cursor-pointer drop-shadow-md group-hover:scale-105 transition-transform" alt="Avatar" />
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <aside 
          className={`bg-white border-r border-sky-100 flex flex-col transition-all duration-300 z-10 shadow-[4px_0_24px_rgba(0,0,0,0.02)] ${
            isSidebarOpen ? 'w-80 lg:w-96' : 'w-0 overflow-hidden border-none'
          }`}
        >
          <div className="p-4 border-b border-sky-50 bg-sky-50/50">
          ...
          <div className="flex-1 overflow-hidden relative flex flex-col">
            {activeTab === 'miracles' ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center bg-slate-50 text-slate-800 p-8 h-full">
                <div className="max-w-xl w-full bg-white rounded-3xl shadow-xl border border-sky-100 p-10 text-center relative overflow-hidden">
                  <div className="absolute top-0 inset-x-0 h-32 bg-gradient-to-b from-sky-100/80 to-transparent"></div>
                  
                  <img src="/churchlogo.jpg" alt="St. Michael's Catholic Church" className="h-24 w-auto object-contain mx-auto mb-6 relative z-10 drop-shadow-sm rounded-xl" />
                  
                  <h2 className="text-3xl font-extrabold text-sky-950 mb-8 relative z-10">About the Exhibition</h2>
                  
                  <div className="flex flex-col sm:flex-row items-center gap-6 mb-8 relative z-10 text-left bg-sky-50 p-6 rounded-2xl border border-sky-100 shadow-inner">
                    <img src="/author_691a09f6a1753_0_1638780.avif" alt="Jesvin Ruble" className="w-24 h-24 object-cover rounded-full shadow-md border-4 border-white flex-shrink-0" />
                    <div>
                  ...
                  <p className="text-lg text-sky-800 font-medium leading-relaxed mb-10 relative z-10">
                  ...
                  <div className="pt-8 border-t border-sky-100 relative z-10">
                    <p className="font-bold text-sky-900 font-serif italic text-xl">
